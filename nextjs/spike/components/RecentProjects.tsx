  ...
  <div className="container px-5 py-24 mx-auto">
    <div className="flex flex-wrap w-full mb-20">
      ...
      <p className="lg:w-1/2 w-full leading-relaxed text-gray-500">
        Our recent projects include engineering for Scratch (the
        beginner-friendly programming language), web standards for assistive
        technologies like screen-readers, and eviction defense tools for tenants
